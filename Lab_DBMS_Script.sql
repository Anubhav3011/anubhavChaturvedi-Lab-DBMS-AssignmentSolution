...
inner join product on product_details.prod_id=product.pro_id
...
inner join product on product.cat_id=category.cat_id
...
*/
select distinct product.pro_id, product.pro_name from product
inner join product_details on product_details.pro_id=product.pro_id
inner join `order` on `order`.prod_id=product_details.prod_id
